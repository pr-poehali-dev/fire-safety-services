...
const faqs = [
  {
    q: "Сколько стоит Интеллектуальная система мониторинга (ИСМ)?",
    a: "Стоимость подключения ИСМ зависит от типа и количества противопожарных систем на объекте. В среднем — от 35 000 руб. за первоначальную установку оборудования и от 5 000 руб./мес. за круглосуточный мониторинг с AI-аналитикой. Точную стоимость рассчитываем бесплатно после обследования объекта.",
  },
  {
