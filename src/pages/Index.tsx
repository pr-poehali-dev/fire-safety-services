...
const services = [
  {
    ...
    details: "Первичный анализ журнала событий приёмно-контрольного прибора проводит искусственный интеллект, помогающий отслеживать реальную ситуацию по всем неисправностям и событиям. На основании этих отчётов наши операторы круглосуточно отслеживают ситуацию на объекте, отправляют краткий отчёт ответственным лицам и в случае необходимости имеют возможность оперативно отправить ремонтную бригаду.",
